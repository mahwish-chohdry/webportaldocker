...
class DistributorDigitalTwin extends React.Component<any, any> {
            ...
            <div className="content">
                <Grid fluid>
                    <Row>
                        <Col md={12}>
                            <Card
                                title="Distributor Digital twin"
                                category=""
                                ctTableFullWidth
                                ctTableResponsive
...
export default connect(mapStateToProps, mapDispatchToProps)(DistributorDigitalTwin);